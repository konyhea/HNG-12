      ...
      <section className="section-attendee-details">
        <div className="ticket-selection-container">
          ...
          <div className="ticket-selection-type-container">
            <TicketType type="Regular Access" price="Free" amount="20/52" />
            <TicketType type="VIP Access " price="$50" amount="20/52" />
            <TicketType type="VVIP Access" price="$150" amount="20/52" />
          </div>
          <label for="amount" className="ticket-number">
            {" "}
            Number of Tickets
          </label>
